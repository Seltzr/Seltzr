// -----------------------------------------------------------------------
// <copyright file="SeltzrOptionsBuilder.ResultWriters.cs" company="John Lynch">
...
namespace Seltzr.Options.Builder {
	...
	public partial class SeltzrOptionsBuilder<TModel, TUser>
		...
		/// </summary>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> WriteJson() => this.WriteJson(null);
		...
		/// </summary>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> WriteXml() => this.UseResultWriter<XmlResultWriter<TModel>>();
