// -----------------------------------------------------------------------
// <copyright file="SeltzrOptionsBuilder.AuthProviders.cs" company="John Lynch">
...
namespace Seltzr.Options.Builder {
	...
	public partial class SeltzrOptionsBuilder<TModel, TUser>
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> AuthHeaderAsync(
			string headerName,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> AuthQueryAsync(
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> AuthAsync(
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public SeltzrOptionsBuilder<TModel, TUser> Auth(
