...
namespace Seltzr.Extensions {
	...
	public static class SeltzrOptionsBuilderExtensions {
		...
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthBasic<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthBasicAsync<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthAsync<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> Auth<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthHeader<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthHeaderAsync<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
			string parameterName,
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthQuery<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
			string parameterName,
			Func<string, bool> handler)
			where TModel : class {
		...
		/// </param>
		/// <returns>This <see cref="SeltzrOptionsBuilder{TModel, TUser}" /> object, for chaining</returns>
		public static SeltzrOptionsBuilder<TModel, NoUser> AuthQueryAsync<TModel>(
			this SeltzrOptionsBuilder<TModel, NoUser> builder,
			string parameterName,
			Func<string, Task<bool>> handler)
			where TModel : class {
