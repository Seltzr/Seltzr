...
namespace Seltzr.EntityFrameworkCore.Options {
	using System;
	...
	using Seltzr.EntityFrameworkCore.Operations;
	...
	public class
		...
		internal EntityFrameworkSeltzrOptionsBuilder(IApplicationBuilder app, Type contextType, string baseRoute, Action<IEndpointConventionBuilder>? routeOptionsHandler) : base(baseRoute, routeOptionsHandler) {
		...
		internal EntityFrameworkSeltzrOptionsBuilder(IApplicationBuilder app, Type contextType, SeltzrOptions<TModel, TUser>? options) : base(options) {
			this.ContextType = contextType;
			this.App = app;
		}
		...
		public override SeltzrOptionsBuilder<TModel, TUser> CreateChild(SeltzrOptions<TModel, TUser>? baseOptions) {
			return new EntityFrameworkSeltzrOptionsBuilder<TModel, TUser>(this.App, this.ContextType, baseOptions);
		}
